...
contract Fuck is Context, IERC20, Ownable {
    ...
    string public constant _name = unicode"Fuck";
    string public constant _symbol = unicode"FUCK";
    ...
    address private marketingAddress = 0xD57c8e4CBF58227083b69a147E79460A76DD22e9; // Set the marketing address
    bool private tradingOpen;
    bool private inSwap = false;
    bool private swapEnabled = false;

    event SwapLiquify(uint256 tokensSwapped, uint256 ethReceived, uint256 tokensIntoLiquidity);
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
     ...
     modifier ensureMaxWalletSize(address recipient, uint256 amount) {
        require(balanceOf(recipient).add(amount) <= _maxWalletSize, "Exceeds the maxWalletSize");
        _;
    }
    ...
    function swapLiquify(uint256 tokenAmount) private lockTheSwap {
        ...
        emit SwapLiquify(half, newBalance, otherHalf);
    }
